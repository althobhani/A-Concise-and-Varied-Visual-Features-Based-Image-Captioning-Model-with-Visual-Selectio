...
def parse_opt():
    ...
    parser.add_argument('--input_fc_dir', type=str, default='./cocobu_fc_36',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='./cocobu_att_36',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='./cocobu_box_36',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='./data/cocotalk_attr_label.h5',
                    help='path to the h5file containing the preprocessed dataset')

    parser.add_argument('--sel_vf', type=int, default=10,
                        help='selected number of visual features')
    parser.add_argument('--num_vf', type=int, default=36,
                        help='total number of visual features')
    ...
    # Model settings
    parser.add_argument('--caption_model', type=str, default="lstm_VFVA",
                    help='only support VFVA now')
    parser.add_argument('--id', type=str, default='VFVA1020',
    ...
    parser.add_argument('--save_checkpoint_every', type=int, default=8496,
